...
const Upload = () => {
  ...
  return (
    <div className="w-screen h-screen">
        {showResult ? <Result forged={forged} percentage={percentage} image={file} />
        :
        <div className="h-full flex flex-col items-center justify-center text-center">
            <h1 className="font-bold text-[78px]">Upload an image to detect Forgery</h1>
            <h4 className="secondary-text text-[#929292] text-2xl font-medium my-20">NB: This application only classifies copy-move forgery <br/>and image splitting forgery</h4>
            <div className="px-24 py-20 rounded-xl shadow-xl">
                <FileUploader
                    multiple={false}
